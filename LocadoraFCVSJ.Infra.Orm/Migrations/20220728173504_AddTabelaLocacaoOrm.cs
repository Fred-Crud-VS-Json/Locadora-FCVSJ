        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanoControlado_LimiteKm = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanoDeCobranca", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanoDeCobranca_TBGrupoOrm_GrupoId",
                        column: x => x.GrupoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TBLocacaoOrm_PlanoDeCobranca_PlanoDeCobrancaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanoDeCobranca_GrupoId",
